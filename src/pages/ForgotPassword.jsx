...
const ForgotPassword = () => {
    ...
    const handleSendOtp = async (e) => {
        ...
        setIsLoading(true);
        try {
            const response = await fetch(`http://${window.location.hostname}:8081/api/observer/forgot-password`, {
                method: 'POST',
    ...
    const handleVerifyOtp = async (e) => {
        ...
        setError('');
        try {
            const response = await fetch(`http://${window.location.hostname}:8081/api/observer/verify-otp`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleResetPassword = async (e) => {
        ...
        try {
            const response = await fetch(`http://${window.location.hostname}:8081/api/observer/reset-password`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
